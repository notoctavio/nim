...
function ProjectMedia({ project }: { project: (typeof PROJECTS)[0] }) {
  ...
  const hasComparison = project.images?.before && project.images?.after
  ...
  return (
    ...
    >
      <MorphingDialogTrigger>
        <div className="group relative aspect-video w-full overflow-hidden rounded-xl bg-zinc-50 dark:bg-zinc-900/50">
          {isVideo ? (
            <video
              src={src}
              autoPlay
      ...
      <MorphingDialogContainer>
        <MorphingDialogContent className="relative flex max-w-5xl flex-col items-center justify-center rounded-3xl bg-white p-4 ring-1 shadow-2xl ring-zinc-200/50 md:p-8 dark:bg-zinc-950 dark:ring-zinc-800/50">
          <div className="w-full space-y-6">
            ...
            <div className="space-y-2 px-2 text-center sm:text-left">
        ...
        <MorphingDialogClose
          className="fixed top-6 right-6 h-fit w-fit rounded-full bg-white/80 p-2 shadow-sm backdrop-blur-md transition-colors hover:bg-white dark:bg-zinc-800/80 dark:hover:bg-zinc-800"
          variants={{
            initial: { opacity: 0 },
            animate: {
              opacity: 1,
